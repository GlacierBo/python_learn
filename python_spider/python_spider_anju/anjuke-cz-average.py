...
def getHTMLInfo(html):
    ...
    for house_detail in house_details:
        ...
        sql = "insert into anju_cz_community(houseName,houseUrl,housePrice,houseAddress,buildData) value(%s,%s,%s,%s,%s)"
        try:
            # 执行SQL语句
...
if __name__ == '__main__':
    for pn in range(1,50):
        try:
            ...
            url = "https://cz.anjuke.com/community/p"+str(pn)+"/"
            print(url)
